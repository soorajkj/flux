...
export default function ThemeToggler() {
  ...
  return (
    <Toggle
      ...
      className="bg-zinc-200 text-zinc-600 dark:bg-zinc-800 dark:text-zinc-50 fixed bottom-12 right-8 select-none rounded-full border border-transparent px-3 py-3 focus:outline-none"
    >
