  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption: "relative flex items-center text-neutral-300 mb-2",
        ...
        cell: "size-8 text-neutral-400 rounded-sm",
        day: "flex items-center justify-center size-8 leading-none rounded",
        day_today: "size-8 bg-red-500 text-neutral-50 !rounded-full",
        day_selected: "bg-blue-500 text-neutral-50",
