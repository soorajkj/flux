  ...
  return (
    <input
      ...
      className={classnames(
        "flex h-10 w-full rounded-md border border-color-grey-200 bg-color-grey-000 px-3 py-2 text-base text-color-grey-800 ring-offset-color-primary-400 file:border-0 file:bg-color-transparent file:text-sm file:font-medium placeholder:text-color-grey-400 focus-visible:border-color-primary-200 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-color-primary-100 focus-visible:ring-offset-0 disabled:bg-color-grey-100 disabled:opacity-50 peer-[.error]:border-color-error-400 peer-[.error]:ring-color-error-100",
        className
      )}
      {...rest}
    />
