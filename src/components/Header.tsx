    ...
    <header className="h-auto w-full overflow-hidden">
      <div className="flex h-14 w-full items-center justify-between px-4">
        <Link
          href="dashboard"
          aria-label="daybook"
          className="relative inline-flex h-10 w-10 cursor-pointer select-none items-center justify-center overflow-hidden rounded-lg border border-color-base-100 bg-color-base-000"
        >
